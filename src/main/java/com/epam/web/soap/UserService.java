...
public interface UserService extends com.epam.web.factory.UserService {
    ...
    @WebMethod
    @RequestWrapper(localName = "logOut", targetNamespace = "http://soap.web.epam.com/", className = "com.epam.web.soap.LogOut")
    @ResponseWrapper(localName = "logOutResponse", targetNamespace = "http://soap.web.epam.com/", className = "com.epam.web.soap.LogOutResponse")
    @WebResult(name = "return", targetNamespace = "")
